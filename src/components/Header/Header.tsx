...
const Header: React.FC<InputProps> = ({searchQuery, onSearchChange}) => {
    return (
      <header className={styles.header}>
        <search className={styles.search}>
          <input type='text' value={searchQuery} onChange={(e) =>  onSearchChange(e.target.value)} placeholder='Поиск по имени...' className={styles.searchInput} />
