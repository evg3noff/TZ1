...
const Users: React.FC<UsersProps> = ({ searchQuery }) => {
    ...
    <>
      <div className={styles.userWrapper}>
        {Data.map((user) => (
          <div className={styles.wrapperContent} key={user.id} onClick={() => handleCardClick(user)}>
            ...
            <div className={styles.wrapperContact}>
              <div className={styles.wrapperForContact}>
                ...
                <a href={`tel:${user.phone}`} className={styles.ContactNumber}>
                  {user.phone}
                </a>
              </div>
              <div className={styles.wrapperForContact}>
                ...
                <a href={`mailto:${user.email}`} className={styles.ContactMail}>
                  {user.email}
                </a>
              </div>
            </div>
